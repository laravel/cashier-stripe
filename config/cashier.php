...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | This is the default paper size for invoices generated by Laravel Cashier.
    | Possible values are e.g. 'letter', 'legal' and 'A4'.
    | All available values see: https://github.com/dompdf/dompdf/blob/master/src/Adapter/CPDF.php
    |
    */

    'invoice_format' => env('CASHIER_INVOICE_FORMAT', 'letter'),
