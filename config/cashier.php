...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | This is the model in your application that implements the Billable
    | contract provided by Cashier. It will serve as the primary model you use
    | while interacting with Cashier related methods, subscriptions, and so on.
    |
    */
