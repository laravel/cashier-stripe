...
Before using Cashier, we'll need to add a new table to your database. Don't worry, you can use the `cashier:table` Artisan command to create a migration to add the necessary table. Once the migration has been created, simply run the `migrate` command.
